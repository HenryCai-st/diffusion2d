...
import numpy as np
from diffusion2d.output import output_plots
...
def solve(dx=0.1, dy=0.1, D = 4.):
    ...
    # save time for each plot
    time_list = [n * dt for n in n_output]
    output_plots(time_list, u_list, T_cold=T_cold, T_hot=T_hot)
